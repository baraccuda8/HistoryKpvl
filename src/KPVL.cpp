...
#pragma region Функции обработки со сохранения истории листов
    ...
    //Получаем ID листа
    std::string GetIdSheet(std::string Melt, std::string Pack, std::string PartNo, std::string Sheet, std::string SubSheet, std::string Slab)
    {
        std::string id = "0";

        if(Melt.length() && Pack.length() && PartNo.length() && Sheet.length() && SubSheet.length() && Slab.length())
        {
            std::string comand = "SELECT id FROM sheet WHERE";
            comand += " melt = " + Melt;
            comand += " AND pack = " + Pack;
            comand += " AND partno = " + PartNo;
            comand += " AND sheet = " + Sheet;
            comand += " AND subsheet = " + SubSheet;
            comand += " AND slab = " + Slab;
            comand += ";";
            PGresult* res = conn_kpvl.PGexec(comand);
            //LOG_INFO(SQLLogger, "{:90}| {}", FUNCTION_LINE_NAME, comand);
    ...
    void InsertSheet(T_PlateData& PD, int Pos)
    {
        if(IsSheet(PD))
        {
            ...
            {
                std::string comand = "INSERT INTO sheet ";
                comand += "(";
                comand += "alloy, ";
                comand += "thikness, ";
                comand += "melt, ";
                ...
                if(Pos == 1 || Pos == 2)
                {
                    ...
                    comand += "timeforplateheat, ";
                    comand += "prestostartcomp, ";

                    comand += "posclapantop, ";
                    comand += "posclapanbot, ";
                    comand += "mask, ";
                    comand += "lam1posclapantop, ";
                    comand += "lam1posclapanbot, ";
                    comand += "lam2posclapantop, ";
                    comand += "lam2posclapanbot, ";
                }
                //else if(pos == 3 || pos == 4)
                //{
                //    comand += "posclapantop, ";
                ...
                comand += ss; // "'" + PD.AlloyCodeText->GetString() + "', ";
                sprintf_s(ss, 255, "\x27%s\x27, ", PD.ThiknessText->GetString().c_str());
                comand += ss; // "'" + PD.ThiknessText->GetString() + "', ";

                comand += PD.Melt->GetString() + ", ";
                comand += PD.Slab->GetString() + ", ";
                comand += PD.PartNo->GetString() + ", ";
                comand += PD.Pack->GetString() + ", ";
                comand += PD.Sheet->GetString() + ", ";
                comand += PD.SubSheet->GetString() + ", ";

                if(Pos == 1 || Pos == 2)
                {
                    comand += GenSeqFromHmi.TempSet1->GetString() + ", ";
                    LOG_INFO(HardLogger, "{:90} Speed = {}", FUNCTION_LINE_NAME, Par_Gen.UnloadSpeed->GetString());
                    comand += Par_Gen.UnloadSpeed->GetString() + ", ";
                    comand += Par_Gen.TimeForPlateHeat->GetString() + ", ";
                    comand += Par_Gen.PresToStartComp->GetString() + ", ";

                    //comand += Par_Gen.Par.UnloadSpeed.GetString() + ", ";

                    comand += HMISheetData.SpeedSection.Top->GetString() + ", ";
                    comand += HMISheetData.SpeedSection.Bot->GetString() + ", ";
                    comand += "'" + MaskKlapan + "', ";
                    comand += HMISheetData.LaminarSection1.Top->GetString() + ", ";
                    comand += HMISheetData.LaminarSection1.Bot->GetString() + ", ";
                    comand += HMISheetData.LaminarSection2.Top->GetString() + ", ";
                    comand += HMISheetData.LaminarSection2.Bot->GetString() + ", ";
                }
                comand += std::to_string(Pos);
    ...
    void UpdateSheetPos(T_PlateData& PD, std::string id, int Pos)
    {
        ...
        //if(pos == 3)
            //LOG_ERROR(SQLLogger, "{:90}| {}", FUNCTION_LINE_NAME, pos);
        if(IsSheet(PD))
        {
            comand += " pos = " + std::to_string(Pos);
            comand += " WHERE";
            comand += " melt = " + PD.Melt->GetString();
            comand += " AND pack = " + PD.Pack->GetString();
            comand += " AND partno = " + PD.PartNo->GetString();
    ...
    bool SetUpdateSheet(PGConnection* con, T_PlateData& PD, std::string update, std::string where)
    {
        ...
        if(IsSheet(PD))
        {
            ...
            std::string comand = "UPDATE sheet SET" + update;
            comand += " WHERE" + where;
            comand += " melt = " + PD.Melt->GetString();
            comand += " AND partno = " + PD.PartNo->GetString();
            comand += " AND pack = " + PD.Pack->GetString();
    ...
    void SheetPos(T_PlateData& PD, int pos)
    {
        //if(IsSheet(PD))
        {
            //if(pos == 0)DataAlloyCodeThikness(PD, HWNDCLIENT::hEditPlate_DataZ0_AlloyCode, HWNDCLIENT::hEditPlate_DataZ0_Thikness);
            //if(pos == 1)DataAlloyCodeThikness(PD, HWNDCLIENT::hEditPlate_DataZ1_AlloyCode, HWNDCLIENT::hEditPlate_DataZ1_Thikness);
            //if(pos == 2)DataAlloyCodeThikness(PD, HWNDCLIENT::hEditPlate_DataZ2_AlloyCode, HWNDCLIENT::hEditPlate_DataZ2_Thikness);
            //if(pos == 3)DataAlloyCodeThikness(PD, HWNDCLIENT::hEditPlate_DataZ3_AlloyCode, HWNDCLIENT::hEditPlate_DataZ3_Thikness);
            //if(pos == 4)DataAlloyCodeThikness(PD, HWNDCLIENT::hEditPlate_DataZ4_AlloyCode, HWNDCLIENT::hEditPlate_DataZ4_Thikness);
            //if(pos == 6)DataAlloyCodeThikness(PD, HWNDCLIENT::hEdit_Sheet_AlloyCode, HWNDCLIENT::hEdit_Sheet_Thikness);

            std::string id = GetIdSheet(PD);
            //LOG_ERROR(SQLLogger, "{:90}| pos = {},  id = {}", FUNCTION_LINE_NAME, pos, id);

            if(id.length() && atoi(id.c_str()) != 0)
            {
                //InsertPos(pos, NamePos[pos]);
                //LOG_INFO(HardLogger, "{:90} UpdateSheetPos pos = {}, id = {}, Melt = {}, PartNo = {}, Pack = {}, Sheet = {}", FUNCTION_LINE_NAME, pos, id, PD.Melt->GetString(), PD.PartNo->GetString(), PD.Pack->GetString(), PD.Sheet->GetString());
                UpdateSheetPos(PD, id, pos);

                if(pos == 1 || pos == 2)
                {
                    //std::string cov = " ll\x27 kk";
                    //std::string set = " alloy = \x27";
                    //set += PD.AlloyCodeText->GetString();
                    //set += cov;
                    //std::string wher = " alloy = \x27\x27 AND";
                    char ss[256];
            ...
            {
                //LOG_INFO(HardLogger, "{:90} InsertSheet pos = {}, Melt = {}, PartNo = {}, Pack = {}, Sheet = {}", FUNCTION_LINE_NAME, pos, PD.Melt->GetString(), PD.PartNo->GetString(), PD.Pack->GetString(), PD.Sheet->GetString());
                InsertSheet(PD, pos);
            }
        }
        //InsertPos(pos, "");
    ...
    void InsertSheetPos0(T_PlateData& PD)
    {
        if(IsSheet0(PD))
        {
            ...
            comand += "slab";
            comand += ") VALUES (0, ";
            comand += "'" + PD.AlloyCodeText->GetString() + "', ";
            comand += "'" + PD.ThiknessText->GetString() + "', ";
    ...
    void UpdateSheetPos0(T_PlateData& PD)
    {
        if(IsSheet(PD))
        {
            ...
            if(sId == "0")
            {
                std::string comand = "UPDATE sheet SET";
                comand += " pos = 0";
                comand += ", alloy = " + PD.AlloyCodeText->GetString();
                comand += ", thikness = " + PD.ThiknessText->GetString();
                comand += ", melt = " + PD.Melt->GetString();
                comand += ", partno = " + PD.PartNo->GetString();
                comand += ", pack = " + PD.Pack->GetString();
                comand += ", sheet = " + PD.Sheet->GetString();
                comand += ", subsheet = " + PD.SubSheet->GetString();
                comand += ", slab = " + PD.Slab->GetString();
                comand += " WHERE id = " + sId;
                comand += ";";
                PGresult* res = conn_kpvl.PGexec(comand);
                LOG_INFO(SQLLogger, "{:90}| {}", FUNCTION_LINE_NAME, comand);
    ...
    //{
    //    if(pos == 0)
    //        SetWindowText(winmap(HWNDCLIENT::hStatPlate_DataZ0), name.c_str());
    //    else if(pos == 1)
    //        SetWindowText(winmap(HWNDCLIENT::hStatPlate_DataZ1), NamePos[1].c_str());
    //    else if(pos == 2)
    //        SetWindowText(winmap(HWNDCLIENT::hStatPlate_DataZ2), NamePos[2].c_str());
    //    else if(pos == 3)
    //        SetWindowText(winmap(HWNDCLIENT::hStatPlate_DataZ3), NamePos[3].c_str());
    //    else if(pos == 4)
    //        SetWindowText(winmap(HWNDCLIENT::hStatPlate_DataZ4), NamePos[4].c_str());
    //    else if(pos == 6)
    //        SetWindowText(winmap(HWNDCLIENT::hEdit_Sheet_DataTime), NamePos[6].c_str());
    //}
    ...
    void OutTime(T_PlateData& PD, HWNDCLIENT chwnd, int pos)
    {
        if(IsSheet(PD))
        {
            ...
            //InsertPos(pos, NamePos[pos]);
            //if(pos == 0)
            //    SetWindowText(winmap(HWNDCLIENT::hStatPlate_DataZ0), NamePos[pos].c_str());
        }
        else
        {
...
#pragma region Зоны печи закалки
    ...
    void DeleteNullSgeet(T_PlateData& PD, int Pos)
    {
        if(IsSheet(PD))
        {
            if(PD.Melt->GetString() != PalletSheet[Pos].Melt
               || PD.Pack->GetString() != PalletSheet[Pos].Pack
               || PD.PartNo->GetString() != PalletSheet[Pos].PartNo
               || PD.Sheet->GetString() != PalletSheet[Pos].Sheet
               || PD.SubSheet->GetString() != PalletSheet[Pos].SubSheet
               || PD.Slab->GetString() != PalletSheet[Pos].Slab)
            {
                ...
                if(atoi(sId.c_str()))
                {
                    std::string comand = "UPDATE sheet SET Pos = (SELECT (Pos + 10) FROM sheet WHERE id = " + sId + ")";
                    comand += " WHERE ID = " + sId;
                    PGresult* res = conn_kpvl.PGexec(comand);
                    LOG_INFO(SQLLogger, "{:90}| {}", FUNCTION_LINE_NAME, comand);
        ...
        namespace Z0{
            ...
            DWORD Data(Value* value)
            {
                ...
                LocSheet(PD, Pos);
                OutTime(PD, HWNDCLIENT::hEditPlate_DataZ0_Time, Pos);
                return 0;
            }
        }
        ...
        namespace Z1{
            ...
            DWORD DataAlloyThikn(Value* value)
            {
                T_PlateData& PD = PlateData[Pos];
                MySetWindowText(winmap(value->winId), value->GetString().c_str());
                OutTime(PD, HWNDCLIENT::hEditPlate_DataZ1_Time, Pos);
                LocSheet(PD, Pos);
                return 0;
            }
            //DWORD DataThikn(Value* value)
        ...
        namespace Z2{
            ...
            DWORD DataAlloyThikn(Value* value)
            {
                T_PlateData& PD = PlateData[Pos];
                MySetWindowText(winmap(value->winId), value->GetString().c_str());
                OutTime(PD, HWNDCLIENT::hEditPlate_DataZ2_Time, Pos);
                LocSheet(PD, Pos);
                return 0;
            }
            //DWORD DataThikn(Value* value)
        ...
        namespace Z3{
            ...
            DWORD Data(Value* value)
            {
                T_PlateData& PD = PlateData[Pos];;
                MySetWindowText(winmap(value->winId), value->GetString().c_str());
                OutTime(PD, HWNDCLIENT::hEditPlate_DataZ3_Time, Pos);
        ...
        namespace Z4{
            ...
            DWORD Data(Value* value)
            {
                T_PlateData& PD = PlateData[Pos];
                MySetWindowText(winmap(value->winId), value->GetString().c_str());
                OutTime(PD, HWNDCLIENT::hEditPlate_DataZ4_Time, Pos);
                SheetPos(PD, Pos);
                DeleteNullSgeet(PD, Pos);
                LocSheet(PD, Pos);
                return 0;
        ...
        namespace Z5{
            ...
            DWORD Data(Value* value)
            {
                T_PlateData& PD = PlateData[Pos];
                MySetWindowText(winmap(value->winId), value->GetString().c_str());
                OutTime(PD, HWNDCLIENT::hEditPlate_DataZ5_Time, Pos);
                //SheetPos(PD, Pos);
                DeleteNullSgeet(PD, Pos);
                LocSheet(PD, Pos);
                return 0;
